"""
This module contains classes to provide Datasets for Pytorch models for
time series forecasting.
The data is either prepared for batch learning or for seq2seq approaches.
"""
...
class DatasetTimeseries(Dataset):
    ...
    validation and test sets before creating
    batches. This creates (mostly) unseen validation data sets timely after
    the training data sets and test sets timely
    after the validation data sets. Such an approach emphasizes pattern
    recognition which are more time independent and
    thus emphasizes generalizability. A sequential splitting, however,
    is more efficient for sequence completion and
...
def provide_series(params: Attribs, flag: str, data_dict: dict) \
